  ...
  const Skills = [
    {
      name: "Understand",
      content:
        "I start by getting to know the project inside and out. This means meetings with the team to understand their goals and what they hope to achieve",
    },
    {
      name: "Ideation",
      content:
        "I use user flows, sketches, and storyboards to visualise the user journey and ensure the visual design is effective.",
    },
    {
      name: "Visual design",
      content:
        "In the visual design phase, I turn my ideas into reality. This is where I create the actual look and feel of the product, including the user interface, prototypes, and interactive elements.",
    },
  ];
      ...
      <div className="about-container">
        <div className="container-padding container mx-auto">
          <div className="grid grid-cols-12 md:gap-8 pt-20">
            <div className="md:col-span-12 col-span-12  about-me">
              ...
              <p id="bio" className="bio_1">
                In my free time, I enjoy cooking, watercolor painting, listening
                to dubstep, traveling, and watching sci-fi movies. For a break
                from the city noise, I love taking walks in the local park—an
                activity I'd recommend to anyone.
              </p>
              <div className="mt-12">
                <h2 className="section_sub_heading mb-10" id="bio">
                  Skills
                </h2>
        ...
        <div className="section-gap idea-section hidden">
          <div className="container container-padding mx-auto">
            ...
            <div
              ref={container}
              className="h-[600px] w-full flex items-center justify-center  overflow-hidden"
            >
