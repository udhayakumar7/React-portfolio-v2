    ...
    <div className='h-screen w-full  relative '>
        <div className='container mx-auto flex items-center relative justify-center h-full w-full'>
            <div className='hero-banner-container' >
                <motion.p initial={{ y: 20 }}  animate={{ y: 0 }} transition={{ type: "tween", duration: 1 , ease: "easeOut" }} >👋, my name is kumar and I am a freelance</motion.p>
                <motion.h2 initial={{ x: 800 }}  animate={{ x: 0 }} transition={{ type: "tween", duration: 2 , ease: "easeOut" }} >Webdeveloper</motion.h2>
                <motion.h3 initial={{ x: -800 }}  animate={{ x: 0 }} transition={{ type: "tween", duration: 2 , ease: "easeOut" }}>&Programmer</motion.h3>
                <motion.span initial={{ x: -800 }}  animate={{ x: 0 }} transition={{ type: "tween", duration: 2 , ease: "easeOut" }} className='location mt-2'>based in Tamil Nadu, India.</motion.span>
